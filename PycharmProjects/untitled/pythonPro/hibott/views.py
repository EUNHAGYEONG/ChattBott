...
def answer(request):
    ...
    if Local_name == '지역선택':
        ...
        return JsonResponse({
            ...
            'keyboard': {
                ...
                'buttons': ['중앙동1가', '중앙동2가', '중앙동3가', '중앙동4가', '해안동1가', '해안동2가', '해안동3가', '해안동4가', '관동1가', '관동2가',
                            ...
                            '신흥동2가', '신흥동3가', '선화동', '유동', '율목동', '도원동', '내동', '경동', '용동', '인현동', '전동', '북성동1가',
                            '북성동2가',
        ...
        return JsonResponse({
            ...
            'keyboard': {
                'type': 'buttons',
                'buttons': ['만석동', '화수동', '송현동', '화평동', '창영동', '금곡동', '송림동', '화평동', '화수2동', '송현1.2동', '송현3동', '송림1동',
                            '송림2동',
        ...
        return JsonResponse({
            ...
            'keyboard': {
                ...
                'buttons': ['효성동', '계산동', '작전동', '서운동', '임학동', '용종동', '병방동', '방축동', '박촌동', '동양동', '귤현동', '상야동', '하야동',
                            '평동', '노오지동', '선주지동', '이화동', '오류동', '갈현동', '둑실동', '목상동', '다남동', '장기동', '효성1동', '효성2동',
                            '계산1동',
        ...
        return JsonResponse({
            ...
            'keyboard': {
                'type': 'buttons',
                'buttons': ['백석동', '시천동', '검암동', '경서동', '공촌동', '연희동', '심곡동', '가정동', '신현동', '석남동', '원창동', '가좌동', '마전동',
                            '당하동',
                            '원당동', '대곡동', '금곡동', '오류동', '왕길동', '불로동', '청라동', '검암경서동', '청라1동', '청라2동', '청라3동', '가정1동',
                            '가정2동',
                            '가정3동', '석남1동', '석남2동', '석남3동', '신현원창동', '가좌1동', '가좌2동', '가좌3동', '가좌4동', '검단동', '불로대곡동',
                            '오류왕길동']
            }
        })
